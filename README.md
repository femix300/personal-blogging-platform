...
This is one of the portfolio projects demonstrating my backend development skills including RESTful API design, database modeling, ORM usage, and clean code architecture.
